...
class BrokerAppln():
    ...
    def invoke_operation(self):
        ...
        try:
            self.logger.info("BrokerMW::invoke_operation")
            ...
            if (self.state == self.State.REGISTER):
                ...
                self.logger.debug("BrokerMW::invoke_operation - register with the discovery service")
                ...
                self.logger.debug("BrokerMW::invoke_operation - check if are ready to go")
                ...
                self.logger.debug("BrokerMW::invoke_operation - add publishers")
                ...
                self.logger.debug("BrokerMW::invoke_operation - Dissemination through broker can now begin")
                return None
...
def parseCmdLineArgs():
  ...
  parser.add_argument("-p", "--port", type=int, default=5999,
  ...
  parser.add_argument("-T", "--num_topics", type=int, choices=range(0, 10), default=9,
